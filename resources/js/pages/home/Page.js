                    ...
                    <section className="col-lg-7 connectedSortable">
                        ...
                        <div className="nav-tabs-custom">
                            ...
                            <div className="tab-content no-padding">
                                ...
                                <div className="chart tab-pane active" id="revenue-chart" style={{ position: 'relative', height: 300 + 'px' }}></div>
                                <div className="chart tab-pane" id="sales-chart" style={{ position: 'relative', height: 300 + 'px' }}></div>
                            </div>
                        </div>
                        ...
                        <div className="box box-success">
                            ...
                            <div className="box-body chat" id="chat-box">
                                ...
                                <div className="item">
                                    <img src="storage/img/user4-128x128.jpg" alt="user image" className="online" />
                                ...
                                <div className="item">
                                    <img src="storage/img/user3-128x128.jpg" alt="user image" className="offline" />
                                ...
                                <div className="item">
                                    <img src="storage/img/user2-160x160.jpg" alt="user image" className="offline" />
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div>
                                        <textarea className="textarea" placeholder="Message"
                                            style={{ width: 100 + '%', height: 125 + 'px', fontSize: 14 + 'px', lineHeight: 18 + 'px', border: 1 + 'px solid #dddddd; padding: 10px' }}></textarea>
                                    </div>
                                </form>
                            </div>
                    ...
                    <section className="col-lg-5 connectedSortable">
                        ...
                        <div className="box box-solid bg-light-blue-gradient">
                            <div className="box-header">
                                ...
                                <div className="pull-right box-tools">
                                    ...
                                    <button type="button" className="btn btn-primary btn-sm pull-right" data-widget="collapse"
                                        data-toggle="tooltip" title="Collapse" style={{ marginRight: 5 + 'px' }}>
                            ...
                            <div className="box-footer no-border">
                                <div className="row">
                                    <div className="col-xs-4 text-center" style={{ borderRight: 1 + 'px solid #f4f4f4' }}>
                        ...
                        <div className="box box-solid bg-teal-gradient">
                            ...
                            <div className="box-body border-radius-none">
                                <div className="chart" id="line-chart" style={{ height: 250 + 'px' }}></div>
                            </div>
